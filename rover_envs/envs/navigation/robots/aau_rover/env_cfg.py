...
@configclass
class AAURoverSimpleDistillationEnvCfg(RoverDistillationEnvCfg):
    """RGB student environment for distilling an AAURoverEnvSimple-v0 height-map teacher."""
