...
# from rover_envs.envs.navigation.rover_camera_env_cfg import RoverRGBCameraSceneCfg
...
# @configclass
# class AAURoverRGBEnvCfgSimple(RoverRGBCameraSceneCfg):
#     """Configuration for the AAU rover environment with RGB camera."""

#     def __post_init__(self):
#         super().__post_init__()

#         # Define robot
#         self.robot = AAU_ROVER_SIMPLE_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
