...
from rover_envs.envs.navigation.rover_env_camera_cfg import RoverRGBResnetEnvCfg, RoverCosmosEnvCfg
from rover_envs.envs.navigation.rover_env_dict_cfg import RoverEnvDictCfg
@configclass
