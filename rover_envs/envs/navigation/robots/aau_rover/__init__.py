...
gym.register(
    id="AAURoverEnvSimpleRiskTeacher-v0",
    entry_point='rover_envs.envs.navigation.entrypoints:RoverEnv',
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": env_cfg.AAURoverEnvSimpleRiskTeacherCfg,
        "best_model_path": f"{os.path.dirname(__file__)}/policies/best_agent_heightmap.pt",
        "skrl_cfgs": {
            "PPO": f"{os.path.dirname(__file__)}/../../learning/skrl/configs/rover_ppo.yaml",
            "TRPO": f"{os.path.dirname(__file__)}/../../learning/skrl/configs/rover_trpo.yaml",
...
gym.register(
    id="AAURoverEnvSimpleVeryRiskTeacher-v0",
    entry_point='rover_envs.envs.navigation.entrypoints:RoverEnv',
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": env_cfg.AAURoverEnvSimpleVeryRiskTeacherCfg,
        "best_model_path": f"{os.path.dirname(__file__)}/policies/best_agent_heightmap.pt",
        "skrl_cfgs": {
            "PPO": f"{os.path.dirname(__file__)}/../../learning/skrl/configs/rover_ppo.yaml",
            "TRPO": f"{os.path.dirname(__file__)}/../../learning/skrl/configs/rover_trpo.yaml",
...
gym.register(
    id="AAURoverEnvRGBDRawHD720-v0",
    entry_point='rover_envs.envs.navigation.entrypoints:RoverEnv',
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": env_cfg.AAURoverRGBDRawHD720EnvCfg,
        "skrl_cfgs": {
            "PPO": f"{os.path.dirname(__file__)}/../../learning/skrl/configs/rover_ppo_dict.yaml",
        },
        "best_model_path": f"{os.path.dirname(__file__)}/policies/best_agent_heightmap.pt",
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": env_cfg.AAURoverRGBDRawWVGAEnvCfg,
        "skrl_cfgs": {
            "PPO": f"{os.path.dirname(__file__)}/../../learning/skrl/configs/rover_ppo_dict.yaml",
        },
        "best_model_path": f"{os.path.dirname(__file__)}/policies/best_agent_heightmap.pt",
